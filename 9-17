        ...
        try:
            with open(file_path, 'r') as file:
                ...
                if lines_with_keywords:
                    ...
                    messagebox.showinfo("Result", 'No occurrences of the words "test", "capstone", "strlen()", or "strsafe.h" found.')
...
def display_results(lines_with_keywords):
    ...
    result_window.title("Lines Containing 'test' or 'capstone', or functions strlen() and strsafe.h")
